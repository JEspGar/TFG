...
<body>
    ...
    <div id="content-wrap">
        <br/><br/><br/>
        <center><h2>Listado de Alumnos por asignatura</h2></center>
        <center><table>
   <tr>
       <th><center><strong>TITULACI&Oacute;N</strong></center></th>
   </tr>
   
   <logic:iterate id="titulacion" name="vectorTitulaciones" scope="request" type="web.data.titulacion">
   <tr>
       <td>
           <h3><html:link action="/opListados?operacion=verAsignaturas" paramId="titulacion" paramName="titulacion" paramProperty="titulacion" >
