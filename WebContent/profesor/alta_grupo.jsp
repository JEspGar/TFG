...
function submitForm()
{
document.forms[0].action = "mantenimientoGrupo.do?method=crear"
document.forms[0].submit();
}
function volver () 
{	 
document.forms[0].action='<html:rewrite forward="menu_profesor"/>';
document.forms[0].submit ();
}
</script>
</head>
...
<body>
    ...
    <div id="content-wrap">
           ...
           <%@include file = "/profesor/contenido/contenido_alta_grupo.jsp" %>
