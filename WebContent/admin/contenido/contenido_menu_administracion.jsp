...
<center><table>
   ...
   <tr>
       <td>
           <h3><html:link action="/admin/mantenimientoTitulacion.do?method=mantener">Mantener Titulacion</html:link>
           </h3>
       </td>    
   </tr>
   <tr>
       <td>
           <h3><html:link action="/admin/altaAsignatura.do?method=inicializar">Crear Asignatura</html:link>
           </h3>
       </td>    
   </tr>
   <tr>
       <td>
           <h3><html:link action="/admin/altaAsignatura.do?method=mantener">Mantener Asignatura</html:link>
           </h3>
       </td>    
   </tr>
   <tr>
